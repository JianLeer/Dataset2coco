...
xml_path = '/home/idip/lijian/pytorch/Dataset/VisDrone2019-DET/train/Annotations_XML/'
xml_file = glob.glob(os.path.join(xml_path, '*.xml'))
PascalVOC2coco(xml_file, '/home/idip/lijian/pytorch/Dataset/VisDrone2019-DET/annotations/train.json')
