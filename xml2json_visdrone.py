...
if __name__ == '__main__':
    typee = 'test'
    xml_path = '/home/idip/lijian/pytorch/Dataset/VisDrone2019-DET/' + typee + '/Annotations_XML/'
    xml_file = glob.glob(os.path.join(xml_path, '*.xml'))
    convert(xml_file, '/home/idip/lijian/pytorch/Dataset/VisDrone2019-DET/annotations/' + typee + '.json')
